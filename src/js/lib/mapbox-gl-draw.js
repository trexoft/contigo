    ...
    return function e(t, n, o) {
        ...
        10: [function(e, t, n) {
            ...
            function r(e) {
                var t = 0;
                if (e.length > 2)
                    for (var n, r, i = 0; i < e.length - 1; i++) n = e[i], t += o((r = e[i + 1])[0] - n[0]) * (2 + Math.sin(o(n[1])) + Math.sin(o(r[1])));
                return t >= 0
            }
        ...
        16: [function(e, t, n) {
            (function(e) {
                ...
                var w = "object" == typeof e && e && e.Object === Object && e,
                    ...
                    P = w || A || Function("return this")(),
                    F = "object" == typeof n && n && !n.nodeType && n,
                    j = F && "object" == typeof t && t && !t.nodeType && t,
                    k = j && j.exports === F,
                    R = k && w.process,
                    D = function() {
                        try {
                ...
                var $, J, z, q = Array.prototype,
                    ...
                    ue = (J = Object.keys, z = Object, function(e) {
                        return J(z(e))
                    }),
                    le = De(P, "DataView"),
                    pe = De(P, "Map"),
                ...
                function Ae(e, t, n, o, r) {
                    return e === t || (null == e || null == t || !Ke(e) && !Ke(t) ? e != e && t != t : function(e, t, n, o, r, a) {
                        ...
                        if (!(n & i)) {
                            var M = b && H.call(e, "__wrapped__"),
                                N = O && H.call(t, "__wrapped__");
                            if (M || N) {
                                var w = M ? e.value() : e,
                                    A = N ? t.value() : t;
        ...
        19: [function(e, t, n) {
            ...
            function s(e) {
                if ("object" == typeof e && null !== e) {
                    var t;
                    if (u(e)) t = [];
                    else if ("[object Date]" === c(e)) t = new Date(e.getTime ? e.getTime() : e);
                    else if (function(e) {
        ...
        24: [function(e, t, n) {
            ...
            t.exports = function(e) {
                ...
                function g(n, r) {
                    ...
                    f = n;
                    var a = s(e, r);
                    h = o(a, e), i.silent || e.map.fire(c.events.MODE_CHANGE, {
                        mode: n
        ...
        33: [function(e, t, n) {
            ...
            t.exports = function e(t) {
                var n, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    u = c.type,
                    l = c.coordinates,
                    p = t.properties && t.properties.id,
                    f = [];
                ...
                function h(e, t) {
                    ...
                    e.forEach(function(e, a) {
                        var c = void 0 !== t && null !== t ? t + "." + a : String(a),
                            u = o(p, e, c, d(c));
                        if (s.midpoints && i) {
                            var l = r(p, i, u, s.map);
                            l && f.push(l)
        ...
        37: [function(e, t, n) {
            "use strict";
            var o = e("./sort_features"),
                r = e("./map_event_to_bounding_box"),
                i = e("../constants"),
                s = e("./string_set"),
        ...
        47: [function(e, t, n) {
            ...
            function o(e) {
                if (this._items = {}, this._nums = {}, this._length = e ? e.length : 0, e)
                    for (var t = 0, n = e.length; t < n; t++) this.add(e[t]), void 0 !== e[t] && ("string" == typeof e[t] ? this._items[e[t]] = t : this._nums[e[t]] = t)
            }
        ...
        62: [function(e, t, n) {
            ...
            t.exports = function() {
                ...
                if (n.forEach(function(e) {
                    ...
                    e._deletedFeaturesToEmit = [], e.ctx.map.fire(o.events.DELETE, {
                        features: c
                    })
                }
        ...
        65: [function(e, t, n) {
            ...
            t.exports = function(e) {
                ...
                function c(e) {
                    ...
                    return o.className = r.classes.CONTROL_BUTTON + " " + t.className, o.setAttribute("title", t.title), t.container.appendChild(o), o.addEventListener("click", function(o) {
