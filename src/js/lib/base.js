...
///////////////////////////////////////////////////////////////////////////
// Dark Mode Detection
var checkDarkModeStatus = localStorage.getItem("hippoDarkModeActive");
// if dark mode on
...
function AddtoHome(time, once) {
  if (once) {
      var AddHomeStatus = localStorage.getItem("hippoAddHomeStatus");
      if (AddHomeStatus === "1" || AddHomeStatus === 1) {
          // already showed up
      }
      else {
          localStorage.setItem("hippoAddHomeStatus", 1)
