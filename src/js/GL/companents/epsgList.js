                ...
                '<div class="modal-content">'+
                    ...
                    '<form>'+
                        ...
                        '<div class="form-group boxed">'+
                            ...
                            '<label class="label" for="epsgSearch" style="font-size:15 !important;">Koordinat Sistemi ara</label>'+
                            '<div class="form-group basic">'+
                                '<div class="input-group mb-3">'+
                                    '<input v-model="search" type="search" class="form-control" id="epsgSearch" placeholder="EPSG Kodu">'+
                            ...
                            '<div class="form-group boxed">'+
                                '<div class="input-wrapper">'+
                                    '<label class="label" for="epsg">Koordiant Sistemi Listesi</label>'+
                                    '<select class="form-control custom-select" v-model="epsglist.selected" id="epsg" required>'+
                        ...
                        '<div class="modal-footer">'+
                            '<div class="btn-inline">'+
                                ...
                                '<button type="button" @click="fileupload.$children[0].readFile(epsglist.selected)" class="btn btn-text-primary" data-dismiss="modal">Devam</button>'+
                            '</div>'+
                        '</div>'+
                    '</form>'+
                '</div>'+
